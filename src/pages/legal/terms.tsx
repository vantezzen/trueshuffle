  ...
  return (
    <Layout>
      ...
      <div className="mx-auto max-w-lg">
        ...
        <p>
          Welcome to LockBox, a secure, end-to-end encrypted secret sharing
          service. LockBox allows you to securely share secrets with other
        ...
        <p>
          ...
          the Services, please contact us at lockbox@vantezzen.io.
        </p>
      </div>
    </Layout>
  );
